...
public class BibleShowModel {
    ...
    String showVerse() {
        final Verse verseData = verse.getValue();
        verseDescription.setValue(verseData.getFullVerse());
        return String.format("%n%s %s", verseData.getShortVerse(), verseData.getText());
    }
